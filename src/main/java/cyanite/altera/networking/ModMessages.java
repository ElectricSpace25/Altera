...
public class ModMessages {
    ...
    public static void registerC2SPackets() {
        ServerPlayNetworking.registerGlobalReceiver(CHANGE_ALIGNMENT_ID, ChangeAlignmentC2SPacket::recieve);
        ServerPlayNetworking.registerGlobalReceiver(ALIGNMENT_CLIENT_SYNC_ID, ChangeAlignmentC2SPacket::recieve);
    }
